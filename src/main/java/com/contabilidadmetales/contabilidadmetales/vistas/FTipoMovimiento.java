...
public class FTipoMovimiento extends javax.swing.JFrame {
    ...
    this.setIconImage(new ImageIcon("Imagenes/FormLogin/favicon.png").getImage());
         this.setTitle("Agregar tipo movimiento");
...
jLabelIcono.setIcon(icon);
 ...
 TipoMovimiento.setRenderer(new CustomComboBoxRenderer());
    ...
    private void initComponents() {
        ...
        TipoMovimiento.setForeground(new java.awt.Color(51, 51, 51));
        ...
        DescripcionTx.setSelectedTextColor(new java.awt.Color(0, 0, 0));
        DescripcionTx.setSelectionColor(new java.awt.Color(200, 244, 254));
